...
#endif
{
   ...
   public partial class Database {
      ...
      const string SQLFactory_DefaultConnectionName = "SQLFactory:DefaultConnectionName";
      const string SQLFactory_DefaultProviderName = "SQLFactory:DefaultProviderName";
      ...
      /// "SQLFactory:DefaultConnectionName" key in the appSettings configuration section, 
      ...
      static DbConnection CreateConnection(out string providerName) {
         ...
         string defaultConnection = ConfigurationManager.AppSettings[SQLFactory_DefaultConnectionName];

         if (defaultConnection == null) {
            throw new InvalidOperationException(
               String.Format(CultureInfo.InvariantCulture, "A default connection name must be provided using the '{0}' key in the appSettings configuration section.", SQLFactory_DefaultConnectionName)
            );
         }
      ...
      /// default provider is used to create the connection (specified by the "SQLFactory:DefaultProviderName"
