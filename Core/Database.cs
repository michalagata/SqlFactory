...
#endif
{
   ...
   /// </summary>
   /// <remarks>
   /// <see cref="Database"/> is the entry point of the <see cref="N:SQLFactory"/> API.
   ...
   public partial class Database : IDisposable, IConnectionContext {
      ...
      void Initialize(string providerName, MetaModel mapping) {
         ...
         if (providerName != null) {
            ...
            string identityKey = String.Format(CultureInfo.InvariantCulture, "SQLFactory:{0}:LastInsertIdCommand", providerName);
            ...
            string batchKey = String.Format(CultureInfo.InvariantCulture, "SQLFactory:{0}:EnableBatchCommands", providerName);
   ...
   public sealed class DatabaseConfiguration {
      ...
      /// a "SQLFactory:{providerInvariantName}:LastInsertIdCommand" entry in the appSettings
      /// configuration section, where {providerInvariantName} is replaced with the provider 
      /// invariant name (e.g. SQLFactory:System.Data.SqlClient:LastInsertIdCommand).
      /// </summary>
      /// <remarks>
      ...
      /// You can override the default value using a "SQLFactory:{providerInvariantName}:EnableBatchCommands" 
      /// entry in the appSettings configuration section, where {providerInvariantName} is replaced with the provider 
      /// invariant name (e.g. SQLFactory:System.Data.SqlClient:EnableBatchCommands).
      /// </summary>
