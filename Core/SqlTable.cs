...
namespace AnubisWorks.SQLFactory
{
    ...
    partial class Database
    {
        ...
        internal string SelectBody(MetaType metaType, IEnumerable<MetaDataMember> selectMembers, string tableAlias)
        {
            ...
            string qualifier = (!String.IsNullOrEmpty(tableAlias)) ? QuoteIdentifier(tableAlias) + "." : null;
            ...
            while (enumerator.MoveNext())
            {
                ...
                string columnAlias = !String.Equals(mappedName, memberName, StringComparison.Ordinal) ? memberName : null;
