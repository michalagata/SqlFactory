...
namespace AnubisWorks.SQLFactory.ObjectDumper
{
    class Program
    {
        ...
        void Run()
        {
            ...
            Console.WriteLine("SQLFactory Sample Runner");
            Console.WriteLine("==========================");
            ...
            try
            {
                ...
                {
                    Console.WriteLine("Server Version: {0}", ((DbConnection)db.Connection).ServerVersion);
                }
